    ...
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col text-right">
                ...
                <button class="btn btn-sm btn-dark" id="sortToggleBtn">
                    <i class="fa fa-sort"></i>&nbsp;Sort: Latest First
                </button>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#sortToggleBtn').click(function() {
            ...
            $(this).html(`<i class="fa fa-sort"></i>&nbsp;Sort: ${sortAscending ? 'Oldest First' : 'Latest First'}`);
